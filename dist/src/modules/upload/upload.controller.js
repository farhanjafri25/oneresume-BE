...
let UploadController = class UploadController {
    ...
    async upload(file, dto) {
        ...
        return this.uploadService.uploadAndCreateVersion(file, dto.userId, dto.resumeId, dto.variantId);
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, upload_resume_dto_1.UploadResumeDto]),
